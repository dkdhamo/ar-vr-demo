  ...
  useEffect(() => {
    const onScroll = () => {
      if (window.scrollY > 50) {
        setScrolled(true);
        document.getElementsByClassName("logo-img img").style.backgroundcolor='#fdfdfd00'
  ...
  return (
    <Router>
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#projects" className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('projects')}>Experiments</Nav.Link>
      ...
      <form className="form-inline mt-4 mb-4">
        <MDBIcon icon="search" />
        <input className="form-control form-control-sm ml-3 w-70" type="text" placeholder="Search" aria-label="Search" />
      </form>
    </MDBCol>
            </span>
          </Navbar.Collapse>
